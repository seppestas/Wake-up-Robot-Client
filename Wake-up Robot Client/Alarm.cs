            ...
            get
            {
                ...
                switch (timetillAlarm.Days)
                {
                    ...
                    case (2):
                        ...
                        break;
                    default:
                        date = dateTime.ToString("dddd", CultureInfo.CreateSpecificCulture("nl-BE")) + " " + dateTime.Day + " " + dateTime.ToString("MMMM", CultureInfo.CreateSpecificCulture("nl-BE"));
                        break;
                }

                return date + " om " + dateTime.TimeOfDay.ToString(@"hh\:mm", CultureInfo.CreateSpecificCulture("nl-BE"));
            }
        }
